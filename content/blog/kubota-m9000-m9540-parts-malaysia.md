...
<!-- 🖼️ IMAGE: HERO
search: "kubota M9540 tractor paddy field rice farming malaysia kedah"
sources: Wikimedia Commons (https://commons.wikimedia.org/wiki/Category:Kubota_tractors) · Kubota Global press (https://www.kubota.com/en/news/) · MADA Malaysia (https://www.mada.gov.my/en/) · Google Images: "kubota m9540 paddy field malaysia"
...
<!-- 🖼️ IMAGE: INLINE — MAP/REGION
search: "kedah paddy field aerial malaysia muda rice granary"
sources: Wikimedia Commons (https://commons.wikimedia.org/wiki/Category:Rice_paddies_in_Kedah) · Bernama photo archive · Tourism Malaysia (https://www.tourism.gov.my) · Google Images: "kedah paddy field aerial view"
...
<!-- 🖼️ IMAGE: INLINE — PARTS
search: "kubota tractor clutch disc pressure plate assembly worn vs new"
sources: Unsplash "tractor clutch" · Pexels "clutch plate" · TractorByNet forums photos (https://www.tractorbynet.com/forums/kubota/) · eBay/Alibaba listing images used editorially
...
1. **Tractor model** (M9000 or M9540, and approximate year if known)
2. **Serial number** (if plate is still readable)
3. **Engine hours** if displayed
4. **Description of the symptom** (not just the part name — e.g., "hydraulic lift won't hold position" tells us more than "need hydraulic part")
5. **A photo** if you have one
...
> **Pre-filled message:** "Hi, I need parts for my Kubota M9000 / M9540. Model: [X], Serial: [X], Issue: [X]"
