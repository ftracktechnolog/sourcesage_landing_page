          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-blue-800 text-xs font-bold uppercase tracking-widest mb-6">
                <Droplets className="w-4 h-4 text-blue-600" /> Kubota OEM Part — Water Pump
              </div>
              <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight mb-4">
                Kubota 1G772-03310
              </h1>
              <p className="text-2xl font-bold text-blue-600 mb-4">Water Pump — V1505 & V2403 Engines</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
              {COMPATIBLE_MODELS.map(m => (
                <div key={m.model} className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
                  ...
                  <p className="text-sm font-semibold text-blue-600 mb-2">Engine: {m.engine}</p>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                {[
                  ...
                  { icon: <Thermometer className="w-6 h-6 text-blue-500" />, title: 'OEM & Aftermarket', body: 'Choose genuine Kubota or cost-effective aftermarket alternatives — both tested.' },
