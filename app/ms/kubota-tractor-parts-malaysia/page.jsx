      ...
      <div className="min-h-screen font-sans text-slate-900 antialiased">
        <nav className="bg-white shadow-sm sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <Link href="/ms" className="flex items-center"><span className="font-heading font-bold text-xl text-accent tracking-tight">SourceSage</span><span className="font-bold text-xl text-green-600">.ai</span></Link>
        ...
        <section className="py-16 bg-slate-50 border-y border-slate-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:grid lg:grid-cols-2 lg:gap-16 items-start"><div><h2 className="text-2xl font-bold text-slate-900 mb-6">Kenapa Bengkel Perak Pilih SourceSage</h2><ul className="space-y-4 text-sm text-slate-600"><li className="flex items-start gap-3"><ShieldCheck className="w-5 h-5 text-accent shrink-0 mt-0.5" /><span>Perolehan pelbagai jenama — bukan ejen jenama tunggal</span></li><li className="flex items-start gap-3"><MapPin className="w-5 h-5 text-accent shrink-0 mt-0.5" /><span>Berpangkalan di Ipoh, Perak — kehadiran tempatan</span></li><li className="flex items-start gap-3"><Wrench className="w-5 h-5 text-accent shrink-0 mt-0.5" /><span>OEM + aftermarket berkualiti dengan harga kompetitif</span></li><li className="flex items-start gap-3"><AlertTriangle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" /><span>Traktor vintaj dan yang dihentikan adalah kepakaran kami</span></li></ul></div><div className="mt-12 lg:mt-0 bg-accent/10 rounded-2xl p-8 border border-blue-100"><h3 className="font-bold text-lg text-slate-900 mb-4">Perlukan Alat Ganti Kubota?</h3><p className="text-slate-600 mb-6">Hantarkan model dan alat ganti yang diperlukan. Kami mengesahkan ketersediaan dalam 24-48 jam.</p><WhatsappCTA label="ms-kubota-main-cta" message="Hi, saya perlukan alat ganti traktor Kubota. Model: ___ Kod enjin: ___ Alat ganti diperlukan: ___" className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3.5 rounded-xl font-bold transition-all w-full"><MessageCircle className="w-5 h-5" /> Minta Sebut Harga Alat Ganti Kubota</WhatsappCTA></div></div></section>
