  ...
  return (
    <>
      ...
      <div className="min-h-screen font-sans text-slate-900 antialiased">
        ...
        <div className="bg-slate-50 border-b border-slate-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-slate-500"><Link href="/zh" className="hover:text-blue-600 transition-colors">首页</Link><span className="mx-2">/</span><span className="text-slate-700 font-medium">久保田拖拉机零件</span></div></div>
        <header className="bg-white pt-16 pb-20 border-b border-slate-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 text-blue-800 text-xs font-bold uppercase tracking-widest mb-6"><MapPin className="w-4 h-4" /> 马来西亚快速采购</div><h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight mb-6 max-w-3xl">久保田拖拉机零件在马来西亚</h1><p className="text-lg text-slate-600 max-w-2xl leading-relaxed">我们采购难以找到的久保田拖拉机零件 — 包括本地经销商不库存的零件。快速采购，24小时供应确认，发货马来西亚全境。</p></div></header>
        ...
        <section className="py-16 bg-slate-50 border-y border-slate-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:grid lg:grid-cols-2 lg:gap-16 items-start"><div><h2 className="text-2xl font-bold text-slate-900 mb-6">中国客户选择SourceSage的原因</h2><ul className="space-y-4 text-sm text-slate-600"><li className="flex items-start gap-3"><ShieldCheck className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" /><span>多品牌采购 — 非单一品牌代理商</span></li><li className="flex items-start gap-3"><MapPin className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" /><span>总部位于霹雳州怡保 — 本地化服务</span></li><li className="flex items-start gap-3"><Wrench className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" /><span>OEM + 优质替换件，价格有竞争力</span></li><li className="flex items-start gap-3"><AlertTriangle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" /><span>老式和停产拖拉机是我们的专长</span></li></ul></div><div className="mt-12 lg:mt-0 bg-blue-50 rounded-2xl p-8 border border-blue-100"><h3 className="font-bold text-lg text-slate-900 mb-4">需要久保田零件？</h3><p className="text-slate-600 mb-6">发送您的型号和所需零件。我们在24-48小时内确认供应。</p><WhatsappCTA label="zh-kubota-main-cta" message="你好，我需要久保田拖拉机零件。型号：___ 发动机代码：___ 所需零件：___" className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3.5 rounded-xl font-bold transition-all w-full"><MessageCircle className="w-5 h-5" /> 请求久保田零件报价</WhatsappCTA></div></div></section>
