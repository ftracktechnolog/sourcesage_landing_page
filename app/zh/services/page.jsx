      ...
      <div className="min-h-screen font-sans text-slate-900 antialiased">
        ...
        <footer className="bg-bg-alt py-12 text-muted border-t border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center pt-6 border-t border-border"><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted">© 2026 SourceSage.ai. 零件采购服务，马来西亚。</p></div>
          </div>
        </footer>
      </div>
    </>
